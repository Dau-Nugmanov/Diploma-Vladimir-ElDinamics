  ...
  with HorScale do
    ...
    begin
      ...
      begin
        ...
        if Grid then
        begin
          Bitmap.Canvas.MoveTo(XG, 0);
          Bitmap.Canvas.LineTo(XG, Height);
        end;
        Bitmap.Canvas.TextOut(XG+1, Height+Canvas.Font.Height-1, FloatToStrF(
          X, ffGeneral, 2, 2))
      end;
    end;
  with VerScale do
    ...
    begin
      ...
      begin
        ...
        if Grid then
        begin
          Bitmap.Canvas.MoveTo(0, YG);
          Bitmap.Canvas.LineTo(Width, YG);
        end;
        Bitmap.Canvas.TextOut(0, YG+1, FloatToStrF(
          Y, ffGeneral, 2, 2));
      end;
    end;
end;
...
begin
  ...
  LastInf := 0;
  TempPen := TPen.Create;
  TempPen.Assign(FMainBitm.Canvas.Pen);
  ...
  FMainBitm.Canvas.Pen.Assign(TempPen);
  TempPen.Free;
end;
