...
type
  ...
  private
    function DrawCurrent(Points: TPoints; Min, Max: Integer;
     UseWindow: Boolean; Plot: Tsp_XYPlot; Line: Tsp_XYLine;
     MaxFreq: Integer): Extended;
  public
    procedure Draw(FPoints, BPoints: TPoints; MinF, MaxF, MinB, MaxB: Integer;
      UseWindowF, UseWindowB: Boolean; CalcCoef: Boolean;
      MaxFreq: Integer);
  end;
...
begin
  ...
  if MaxFreq < 0 then
    ...
    Plot.BottomAxis.SetMinMax(0, MaxFreq);
