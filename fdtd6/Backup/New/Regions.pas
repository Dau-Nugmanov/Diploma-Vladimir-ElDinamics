...
свойства:
  ...
  private
    ...
    Sym: Boolean;
    procedure CalcSym;
    procedure CalcAssym(LeftRoot, RightRoot, Root: Extended);
  protected
...
procedure TRectSelfField.CalcAssym(LeftRoot, RightRoot, Root: Extended);
var
...
procedure TRectSelfField.CalcSym;
var
  Funct: TCustomFunction;
...
{  if Sym then
  ...
  if Sym then
    ...
    CalcAssym(LeftRoot, RightRoot, Root);
