...
//перезапуск процесса
  ...
  spLineIntF.Clear;
  spLineIntB.Clear;
  spIntegralF.BottomAxis.SetMinMax(0, 2000);
  spIntegralB.BottomAxis.SetMinMax(0, 2000);
  LastAddedI := 0;
end;
...
begin
  ...
  begin
//    Draw(IntFPoints, IntBPoints, Min, Max);
    Draw(IntFPoints, IntBPoints, MinF, MaxF, MinB, MaxB,
      FSForm.cbWindowF.Checked, FSForm.cbWindowB.Checked);
    Show;
  end;
end;
